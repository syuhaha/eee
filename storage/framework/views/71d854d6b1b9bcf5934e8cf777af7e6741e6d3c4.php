  ...
  <div class="wrap">
    <div class="card">
      ...
      <?php if(session('success')): ?>
        <div style="color:#059669;background:#ecfdf5;padding:10px;border-radius:8px"><?php echo e(session('success')); ?></div>
      <?php endif; ?>
      ...
      <form method="POST" action="<?php echo e(route('fyjt.submit')); ?>" id="fyjtStep2" novalidate>
        <?php echo csrf_field(); ?>

        
        <input type="hidden" name="token" value="<?php echo e(session('fyjt_valid_token', old('token'))); ?>">
...
<?php /**PATH F:\phpstudy81\WWW\fyjt\resources\views/fyjt-step2.blade.php ENDPATH**/ ?>